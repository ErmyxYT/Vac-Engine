...
class PreferencesMenu extends ui.OptionsState.Page
{
	...
	public function new()
	{
		...
		createPrefItem('VSlice FreePlay', 'vslice-fp', false);
		createPrefItem('Winning Icon', 'winning-icon', false);
		createPrefItem('Time Bar', 'time-bar', false);
		createPrefItem('Vanilla UI', 'vanilla-ui', false);
	...
	public static function initPrefs():Void
	{
		...
		preferenceCheck('vslice-fp', false);
		preferenceCheck('vanilla-ui', false);
		preferenceCheck('time-bar', false);
		preferenceCheck('winning-icon', false);
