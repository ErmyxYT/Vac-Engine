...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		{
			case 'tutorial':
				dialogue = ["Hey you're pretty gay.", 'Use the arrow keys to keep up \nwith my ass.'];
			case 'bopeebo':
				dialogue = [
					'HEY!',
					"You think you can just sing\nwith my bitch like that?",
		...
		if (PreferencesMenu.getPref('vanilla-ui')) {
	...
	override public function update(elapsed:Float)
	{
		...
		if (accuracy == 0 && !PreferencesMenu.getPref('vanilla-ui'))
        ...
        else if (healthBar.percent > 80 && PreferencesMenu.getPref('winning-icon'))
        ...
        else if (healthBar.percent < 20 && PreferencesMenu.getPref('winning-icon'))
	...
	private function popUpScore(strumtime:Float, daNote:Note):Void
	{
		...
		if (isSick && !curStage.startsWith('school') && PreferencesMenu.getPref('splash'))
		{
